...
export default function Home() {
    ...
    <div style={{
      ...
      <header style={
      {
        ...
        <nav style={{
            ...
            <div>
              <a style={{cursor:"pointer", paddingLeft:"1rem"}}>
                Recentes
              </a>
            </div>
        </nav>
  ...
  <div style={{
    ...
    {/* + */}
    <div style={{cursor:"pointer", fontSize:"20px", fontWeight:"normal"}}>+</div>
  ...
  <div style={{ display:"flex", alignItems:"center", gap:"6px" }}>
    ...
    <div style={{cursor:"pointer"}}>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        strokeWidth="1.5" stroke="currentColor" width="25" height="25">
